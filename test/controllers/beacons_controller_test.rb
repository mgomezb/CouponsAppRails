...
class BeaconsControllerTest < ActionController::TestCase
  ...
  test "should create beacon" do
    assert_difference('Beacon.count') do
      post :create, beacon: { description: @beacon.description, local_id: @beacon.local_id, major: @beacon.major, minor: @beacon.minor, proximity_uuid: @beacon.proximity_uuid }
    end
  ...
  test "should update beacon" do
    patch :update, id: @beacon, beacon: { description: @beacon.description, local_id: @beacon.local_id, major: @beacon.major, minor: @beacon.minor, proximity_uuid: @beacon.proximity_uuid }
    assert_redirected_to beacon_path(assigns(:beacon))
  end
